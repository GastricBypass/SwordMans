...
// TODO: A LOT of duplicated code from PlayerGun. Not quite sure how to structure it to avoid that.
public class AIEnemyGun : AISwordMan
{
    ...
    protected override void AttackInput() // Difference between AIEnemyGun and PlayerGun
    {
        if (aggressive)
        {
            base.AttackInput();
    ...
    protected override void BlockInput() // Difference between AIEnemyGun and PlayerGun, there are only these two
    {
